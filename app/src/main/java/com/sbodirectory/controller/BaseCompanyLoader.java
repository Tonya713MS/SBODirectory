 ...
 */
public class BaseCompanyLoader extends AsyncTaskLoader<List<Company>> {
    private static final String TAG = "ADP_AppListLoader";
    private static final boolean DEBUG = true;
    private List<Company> _datas;
    public BaseCompanyLoader(Context context) {
        super(context);
    }
    ...
    public List<Company> loadInBackground() {
        ...
        if (!TextUtils.isEmpty(result)) {
            try {
                ...
                JSONArray jsA = jso.getJSONArray("companies");
     ...
     */
    @Override
    public void deliverResult(List<Company> apps) {
        if (isReset()) {
    ...
    @Override
    public void onCanceled(List<Company> apps) {
     ...
     */
    private void releaseResources(List<Company> apps) {
