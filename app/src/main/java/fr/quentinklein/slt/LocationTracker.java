...
public abstract class LocationTracker implements LocationListener {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (!isLocationFound && isListening) {
                            ...
                            onTimeout(LocationTracker.this);
                        }
                    }
    ...
    /**
     * Best effort, it calls {@link #onLocationChanged(android.location.Location)} with static field named {@link #location} if it is not null
     */
     ...
     */
    public abstract void onLocationFound(LocationTracker tracker, Location location);

    /**
     * Called when the tracker had not found any location and the timeout just happened
     */
    public abstract void onTimeout(LocationTracker tracker);
     ...
     * By default, this method do nothing but a Log on i
     * @see android.location.LocationListener#onStatusChanged(String, int, android.os.Bundle)
     */
    @Override
